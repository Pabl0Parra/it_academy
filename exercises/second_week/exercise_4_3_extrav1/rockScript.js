...
function optionSelectedUser() {
  ...
  const isTied =
    (pcSelection === "Rock" && userSelection === "Rock") ||
    (pcSelection === "Paper" && userSelection === "Paper") ||
    (pcSelection === "Scissors" && userSelection === "Scissors");
  const iWon =
    (pcSelection === "Rock" && userSelection === "Scissors") ||
    (pcSelection === "Paper" && userSelection === "Rock") ||
    (pcSelection === "Scissors" && userSelection === "Paper");
  const youWon =
    (pcSelection === "Paper" && userSelection === "Scissors") ||
    (pcSelection === "Scissors" && userSelection === "Rock") ||
    (pcSelection === "Paper" && userSelection === "Scissors");
